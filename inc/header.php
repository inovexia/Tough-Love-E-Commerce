...
<div class="overlay1">
        ...
        <div id="mob-menu" class="mob-menu position-fixed">
         ...
         <ul class="list-unstyled p-0 mx-0 mob-second-menu">
            <li class="d-flex"><span><img src="./images/logo2.png" alt="" class=""
                /></span>Hush</li>
            <li class="d-flex"><span><img src="./images/logo2.png" alt="" class=""
                /></span>Hush</li>
         </ul>
         <p class="leran-more">Become a Nike Member for the best products, inspiration and stories in sports. Learn More.<a href="">Learn More.</a></p>
